...
print(f"There are {numfires} fires near you. There are {numintense} high risk fires. Closest emergency center, {em_name} "
      f"is {round(em_dist)}km away on {em_address} and their number is {em_phone}")
